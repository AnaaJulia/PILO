        ...
        <ul>
            ...
            <div class="dropdown-menu">
                <div class="dropdown-item user-options">
                    ...
                    <div class="options">
                        <p>Rayniier dos Santos Almeidaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa</p>
                        <p>@usuario</p>
                        <a class="linkclick" href="?page=perfil">Meu perfil</a>
                    </div>
                </div>
                <a class="dropdown-item" href="#"><img src="img/icon-switch-user.png">Alternar conta</a>
                <a class="dropdown-item" href="#"><img src="img/icon_leave-account.png">Encerrar sessão</a>
            </div>
        </ul> <!-- ul -->
    </nav> <!-- nav -->
</header> <!-- header -->